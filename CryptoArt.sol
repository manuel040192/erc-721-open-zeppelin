...
contract CryptoArt is ERC721, ERC721Enumerable, Pausable, Ownable {
    ...
    constructor() ERC721("CryptoArt", "CA") {
    ...
    function safeMint(address to) public payable {
        ...
        require(totalSupply() < MAX_SUPPLY, "Can't mint any more tokens.");

        // ❌ Check if ether value is correct
        require(msg.value >= MINT_PRICE, "Not enough ether was sent.");
